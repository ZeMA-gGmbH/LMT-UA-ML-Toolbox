classdef NumFeatRankingUncertainty < SupervisedUncertaintyTrainable & Appliable & Uncertainty
    ...
    methods
        ...
        function this = NumFeatRankingUncertainty(rankingAlg, predictionStack, predArg, lossAlg)
            if nargin > 0
        ...
        function U = uncertainty(this, U_x, data)
            U = U_x(:,this.ranking(1:this.nFeat));            
        end    
    end
end
